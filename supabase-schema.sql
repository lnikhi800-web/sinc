...
DROP POLICY IF EXISTS "sinc_previews_public_read" ON storage.objects;
DROP POLICY IF EXISTS "sinc_previews_service_write" ON storage.objects;
DROP POLICY IF EXISTS "sinc_previews_service_update" ON storage.objects;
